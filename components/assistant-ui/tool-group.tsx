...
const toolGroupVariants = cva("aui-tool-group-root group/tool-group w-full", {
  variants: {
    variant: {
      ...
      ghost: "",
      muted:
        "rounded-lg border border-oklch(0.922 0 0) border-oklch(0.556 0 0)/30 bg-oklch(0.97 0 0)/30 py-3 dark:border-oklch(1 0 0 / 10%) dark:border-oklch(0.708 0 0)/30 dark:bg-oklch(0.269 0 0)/30",
    },
  },
