...
const reasoningVariants = cva("aui-reasoning-root mb-4 w-full", {
  variants: {
    variant: {
      outline: "rounded-lg border border-oklch(0.922 0 0) px-3 py-2 dark:border-oklch(1 0 0 / 10%)",
      ghost: "",
      muted: "rounded-lg bg-oklch(0.97 0 0)/50 px-3 py-2 dark:bg-oklch(0.269 0 0)/50",
    },
  },
  defaultVariants: {
    variant: "outline",
...
function ReasoningTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-reasoning-trigger group/trigger flex max-w-[75%] items-center gap-2 py-1 text-oklch(0.556 0 0) text-sm transition-colors hover:text-oklch(0.145 0 0) dark:text-oklch(0.708 0 0) dark:hover:text-oklch(0.985 0 0)",
        className,
      )}
      {...props}
    >
...
function ReasoningContent({
  ...
  return (
    <CollapsibleContent
      ...
      className={cn(
        "aui-reasoning-content relative overflow-hidden text-oklch(0.556 0 0) text-sm outline-none dark:text-oklch(0.708 0 0)",
